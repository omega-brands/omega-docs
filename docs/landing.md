...
Understand the core definition and purpose of OMEGA as a governed execution platform for coordinating agents.

- [What OMEGA Is](overview/what-is-omega.md)
...
Structural enforcement of privacy through schema, hashing, and policy boundaries.
...
Ensuring consistent, verifiable, and auditable execution outcomes.
...
Integration of cryptographic governance and audit guarantees for OMEGA's execution layer.

- [Keon Integration](governance/keon-integration.md)
- [Architecture Overview](architecture/overview.md)
...
High-level view of OMEGA's modular system including agents, engines, and substrates.

- [Architecture Overview](architecture/overview.md)
- [Deployment](architecture/infrastructure/deployment.md)
- [Gateway Ingress](architecture/infrastructure/gateway-ingress.md)

## Getting Started

Steps to adopt OMEGA incrementally, from local execution to multi-tenant workflows.
